...
class CycleGAN():     
    ...
    def dataload(self):
        ...
        onlyfiles.sort()
        onlyfileslenrem=len(onlyfiles)-round(len(onlyfiles)*0.2)
...
weightoutputpath='/home/arun/Documents/PyWSPrecision/Pyoutputs/cycleganweights/2192021/'
# imgshape=(512,512)
...
# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,weightoutputpath,epochs=1,batch_size=1,imgshape=(512,512,1),totalbatchiterations=1,saveweightflag=True)
