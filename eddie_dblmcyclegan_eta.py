...
# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,weightoutputpath,epochs=1,batch_size=5,imgshape=(512,512,1),totalbatchiterations=2,saveweightflag=True)
...
opmatfile="Losses"+".mat"
imgdic={"G_losses":G_losses,"D_losses":D_losses}
