...
weightoutputpath='/home/arun/Documents/PyWSPrecision/Pyoutputs/cycleganweights/1892021/run2'
# imgshape=(512,512)

# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,weightoutputpath,epochs=2,batch_size=5,imgshape=(512,512,1),totalbatchiterations=1,saveweightflag=True)
