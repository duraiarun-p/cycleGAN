...
# -*- coding: utf-8 -*-
"""
Created on Mon Oct 18 17:45:50 2021
...
class CycleGAN(keras.Model):     
    ...
    def dataload3D_1(self):
        ...
        #     return CTblocks             
        # CTblocks=blkextraction(CT,CTsiz1,self.patch_size,self.depth_size)
        # CBblocks=blkextraction(CBCT,CBsiz,self.patch_size,self.depth_size)
...
#%% 3D
    ...
    def __init__(self,mypath,weightoutputpath,epochs,batch_size,imgshape,patch_size,depth_size,totalbatchiterations,saveweightflag):
...
cGAN=CycleGAN(mypath,weightoutputpath,epochs=1,batch_size=3,imgshape=(512,512,1),patch_size=16,depth_size=32,totalbatchiterations=2,saveweightflag=False)
...
# trainCT,trainCB=cGAN.dataload3D_1()
# trainCB = (
#     .cache()
#     .shuffle(batch_size)
#     .batch(batch_size)
# )
# cGAN.fit((trainCB, trainCT), epochs=1)
# import matplotlib.pyplot as plt

# plt.figure(1),plt.subplot(1,2,1),plt.imshow(batch_CT_img_patch,cmap='gray'),plt.show()
# plt.subplot(1,2,2),plt.imshow(batch_CB_img_patch,cmap='gray'),plt.show()