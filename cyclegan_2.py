...
class CycleGAN():     
    ...
    def traincgan(self):
        ...
        self.GenCT2CB.save_weights("GenCT2CBWeights-40.h5")
        self.GenCB2CT.save_weights("GenCB2CTWeights-40.h5")
        self.DiscCT.save_weights("DiscCTWeights-40.h5")
        self.DiscCB.save_weights("DiscCBWeights-40.h5")
...
# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,epochs=2,batch_size=5,imgshape=(512,512,1),totalbatchiterations=40)
