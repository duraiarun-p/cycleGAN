...
mypath='/home/arun/Documents/PyWSPrecision/datasets/printoutblks/db3/'
...
# batch_size=1
# epochs=1
cGAN=CycleGAN(mypath,weightoutputpath,epochs=1,batch_size=5,imgshape=(256,256,1),batch_set_size=100,saveweightflag=False)
# def run_tf(cGAN):
